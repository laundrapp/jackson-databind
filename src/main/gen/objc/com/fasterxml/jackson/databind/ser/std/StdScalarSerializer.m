...
@implementation ComFasterxmlJacksonDatabindSerStdStdScalarSerializer
...
- (instancetype __nonnull)initWithIOSClass:(IOSClass *)t
  ...
  ComFasterxmlJacksonDatabindSerStdStdScalarSerializer_initWithIOSClass_withBoolean_(self, t, dummy);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LComFasterxmlJacksonDatabindJsonNode;", 0x1, 8, 9, 10, -1, -1, -1 },
  ...
  static const void *ptrTable[] = { "LIOSClass;", "(Ljava/lang/Class<TT;>;)V", "LIOSClass;Z", "(Ljava/lang/Class<*>;Z)V", "serializeWithType", "LNSObject;LComFasterxmlJacksonCoreJsonGenerator;LComFasterxmlJacksonDatabindSerializerProvider;LComFasterxmlJacksonDatabindJsontypeTypeSerializer;", "LJavaIoIOException;", "(TT;Lcom/fasterxml/jackson/core/JsonGenerator;Lcom/fasterxml/jackson/databind/SerializerProvider;Lcom/fasterxml/jackson/databind/jsontype/TypeSerializer;)V", "getSchema", "LComFasterxmlJacksonDatabindSerializerProvider;LJavaLangReflectType;", "LComFasterxmlJacksonDatabindJsonMappingException;", "acceptJsonFormatVisitor", "LComFasterxmlJacksonDatabindJsonFormatVisitorsJsonFormatVisitorWrapper;LComFasterxmlJacksonDatabindJavaType;", "<T:Ljava/lang/Object;>Lcom/fasterxml/jackson/databind/ser/std/StdSerializer<TT;>;" };
  static const J2ObjcClassInfo _ComFasterxmlJacksonDatabindSerStdStdScalarSerializer = { "StdScalarSerializer", "com.fasterxml.jackson.databind.ser.std", ptrTable, methods, NULL, 7, 0x401, 5, 0, -1, -1, -1, 13, -1 };
  return &_ComFasterxmlJacksonDatabindSerStdStdScalarSerializer;
}

@end

void ComFasterxmlJacksonDatabindSerStdStdScalarSerializer_initWithIOSClass_(ComFasterxmlJacksonDatabindSerStdStdScalarSerializer *self, IOSClass *t) {
  ComFasterxmlJacksonDatabindSerStdStdSerializer_initWithIOSClass_(self, t);
}

void ComFasterxmlJacksonDatabindSerStdStdScalarSerializer_initWithIOSClass_withBoolean_(ComFasterxmlJacksonDatabindSerStdStdScalarSerializer *self, IOSClass *t, jboolean dummy) {
  ComFasterxmlJacksonDatabindSerStdStdSerializer_initWithIOSClass_(self, t);
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(ComFasterxmlJacksonDatabindSerStdStdScalarSerializer)
